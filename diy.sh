...
echo "echo \"DISTRIB_REVISION='${version} $(TZ=UTC-8 date "+%Y.%m.%d") Compilde by leizhiren'\" >> /etc/openwrt_release" >> package/lean/default-settings/files/zzz-default-settings
